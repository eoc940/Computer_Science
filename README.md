...
- [시스템 콜(System Call)](./Operating_System/systemCall.md)
- [교착 상태(Dead Lock)](./Operating_System/deadlock.md)
- [CPU 스케줄링](./Operating_System/cpuScheduling.md)
- [스케줄러의 종류](./Operating_System/varietyScheduler.md)
- [동기 VS 비동기](./Operating_System/syncVersusNonsync.md)
- [페이징 & 세그멘테이션](./Operating_System/pagingSegmentation.md)
- [페이지 교체 알고리즘](./Operating_System/pageChange.md)
- [단편화](./Operating_System/simplification.md)
...
- [데이터베이스 설계(ERD)](./Database/erd.md)
- [데이터베이스 설계(정규화)](./Database/normalization.md)
